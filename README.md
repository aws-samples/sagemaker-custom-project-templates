...
> [!Important]
> You can find instructions about SageMaker AI projects based on S3 templates provisioning method in this repositories folder [s3_templates](./s3_templates/README.md) along with custom templates samples.
