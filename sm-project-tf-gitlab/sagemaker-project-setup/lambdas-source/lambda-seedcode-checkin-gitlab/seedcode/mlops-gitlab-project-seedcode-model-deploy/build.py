...
def get_approved_package(model_package_group_name):
    ...
    try:
        ...
        registry_artifact = model_description["InferenceSpecification"]["Containers"][
            0
        ]["ModelDataUrl"]
        model_image_uri = model_description["InferenceSpecification"]["Containers"][0][
            "Image"
        ]
...
def extend_config(
    args, model_package_arn, stage_config, model_image_uri, registry_artifact
):
    """
...
if __name__ == "__main__":
    ...
    model_package_arn, model_image_uri, registry_artifact = get_approved_package(
    ...
    with open(args.import_staging_config, "r") as f:
        staging_config = extend_config(
            args, model_package_arn, json.load(f), model_image_uri, registry_artifact
        )
