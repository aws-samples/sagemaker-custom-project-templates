...
if __name__ == "__main__":
    ...
    batch_pipeline = f"{args.sagemaker_project_name}-{args.sagemaker_project_id}"
    ...
    s3_key_pipeline = f"{args.sagemaker_project_name}-{args.sagemaker_project_id}/pipeline/{args.stage}-v{version}-{args.pipeline_file}"
