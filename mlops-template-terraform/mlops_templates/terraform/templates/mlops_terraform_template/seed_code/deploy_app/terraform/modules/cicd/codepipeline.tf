...
resource "aws_iam_role" "codepipeline_role" {
  name               = "${local.prefix}-${local.sm_project_name}-codepipeline-modeldeploy"
  ...
  policy = <<EOF
{
  ...
  "Statement": [
        ...
        },
        {
            ...
            "Resource": "${aws_codebuild_project.modeldeploy_project.arn}",
            "Effect": "Allow"
        }
    ]
    }
...
resource "aws_codepipeline" "codepipeline" {
  name     = "${local.prefix}-${local.sm_project_name}-${local.pipeline_name}"
  ...
  stage {
    ...
    action {
      ...
      configuration = {
        ProjectName = aws_codebuild_project.modeldeploy_project.name
